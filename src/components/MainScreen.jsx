...
const MainScreen = memo(
	({
		...
		return (
			<div
				id='video-holder'
				className='relative h-[90vh] overflow-y-auto w-full flex flex-wrap justify-center p-2 gap-4 lg:p-4 lg:w-[55vw] bg-slate-900'
			>
				{/* Share Screen */}
				<div
					ref={screenShareRef}
				...
				<div className='w-full fixed bg-slate-300/10 py-2 z-10 bottom-[10vh] flex justify-center'>
					{joined === true ? (
						...
						<button
							...
							style={{
								backgroundImage: 'linear-gradient(to right, #ff8c00, #ff2f96)',
							}}
							onClick={() => {
								setJoined('load');
								joinRoom();
